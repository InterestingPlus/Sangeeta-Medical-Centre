...
import React, { useEffect, useState } from "react";
import doctorData from "./Doctor1.json"; // import your JSON from data folder
import { Link, useParams } from "react-router-dom";
...
const Doctor = () => {
  ...
  useEffect(() => {
    if (name) {
      const found = doctorData.doctors.find(
        (doc) => slugify(doc.name) === name.toLowerCase()
      );
              ...
              <div className="page-header-box">
                ...
                <nav className="wow fadeInUp">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="/about" title="About Mrityanjay Hospital Meerut">
                        About
                      </Link>
                    </li>
                    <li className="breadcrumb-item">
                      <Link to="/about#Doctors">Doctors</Link>
                    </li>
                    <li className="breadcrumb-item active" aria-current="page">
                      {doctor.name}
                    </li>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="team-member-image mb-4">
                <img
                  src={doctor.profileImage || "https://placehold.co/400x400?text=Doctor+Image"}
                  alt={`Dr. ${doctor.name}`}
              ...
              <div className="working-hours">
                ...
                <ul>
                  ...
                  {doctor.emergency && <li>Emergency: {doctor.emergency}</li>}
                </ul>
              </div>
            </div>
            ...
            <div className="col-lg-8">
              <div className="team-member-details">
                <div className="member-detail-header">
                  ...
                  <div className="section-btn">
                    <Link to={`tel:${doctor.phone || "011-6926988"}`} className="btn-default">
                      <span>Make Appointment</span>
                    </Link>
                  </div>
                </div>

                <div className="member-detail-content mb-3">
                  <h3>
                    The Pillar of Ethical Practice in {doctor.location || "Meerut"}
                  </h3>
                  <p className="lead">
                    {doctor.hospital} | {doctor.experienceYears || "N/A"} Years of Experience
                  </p>
                  <p>{doctor.description}</p>
                </div>
                ...
                <div className="member-details">
                  ...
                  {doctor.phone && (
                    <p><strong>Phone: </strong><a href={`tel:+91${doctor.phone}`}>+91 {doctor.phone}</a></p>
                  )}
                </div>

                {doctor.legacy?.length > 0 && (
                  <>
                    <hr />
                    <h3>Clinical Legacy & Experience</h3>
                    <ul>
                      {doctor.legacy.map((item, idx) => (
                ...
                <p>
                  From conservative treatment to advanced surgeries, {doctor.name.split(" ").slice(0, -1).join(" ")} believes in doing what is necessary.
                </p>
                ...
                <ul>
                  {doctor.expertise?.map((expertise, idx) => (
