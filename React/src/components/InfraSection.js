              ...
              <div class="swiper-slide">
                <div class="blog-item">
                  ...
                  <div class="post-item-content">
                    <div class="post-item-body">
                      <h2 class="text-black">
                        World's most advanced Orthopaedic robot
                      </h2>
                    </div>
                    <div class="post-item-footer">
                      <Link
              ...
              {/* <div class="swiper-slide">
                <div class="blog-item">
                  ...
                  <div class="post-item-content">
                    <div class="post-item-body">
                      <h2 class="text-black">
                        Advanced sterilisation (Cold Plasma and steam)
                      </h2>
                    </div>
                    <div class="post-item-footer">
                      <Link
              ...
              <div class="swiper-slide">
                <div class="blog-item">
                  ...
                  <div class="post-item-content">
                    <div class="post-item-body">
                      <h2 class="text-black">
                        Advanced GE and Seimens Ventilators and monitors
                      </h2>
                    </div>
                    <div class="post-item-footer">
                      <Link
              ...
              <div class="swiper-slide">
                <div class="blog-item">
                  ...
                  <div class="post-item-content">
                    <div class="post-item-body">
                      <h2 class="text-black">
                        Highest grade Anaesthesia machines
                      </h2>
                    </div>
                    <div class="post-item-footer">
                      <Link
