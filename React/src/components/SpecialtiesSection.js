    ...
    <>
      <div className="our-services bg-radius-section">
        <div className="container">
          ...
          <div className="row">
            {specialties.map((specialty, index) => (
              <div key={index} className="col-lg-3 col-md-6 mb-4">
                <div className="service-item wow fadeInUp" data-wow-delay={`${index * 0.15}s`}>
                  <div className="service-item-image">
                    <figure>
                      <img
                        src={specialty.image || "https://placehold.co/400x200?text=Specialty+Image"}
                        alt={specialty.alt || specialty.name}
                        loading="lazy"
                  ...
                  <div className="service-body d-flex justify-content-between align-items-center">
                    ...
                    <div className="service-btn">
                      <Link to={`/specialties/${specialty.link}`} title={specialty.title}>
                        <img src="/images/svg-icons/arrow-readmore-btn.svg" alt="More" />
                      </Link>
                    </div>
                  </div>
                </div>
          ...
          <div className="more-service-btn text-center mt-5">
            <Link to="/specialties" className="btn btn-link">
              Find Out More About Our Specialties
              <img src="/images/svg-icons/arrow-long-white.svg" alt="Arrow" />
            </Link>
          </div>
        </div>

        <div className="bg-section bg-radius-section"></div>
      </div>
    </>
  );
};
